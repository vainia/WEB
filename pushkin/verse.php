		...
		<div class="container">
			...
			<main class="content">
				...
				<div style="float: left; width: 100%; margin-top: 20px;">
					<h3 class="widget-title" style="font-size: 26px; padding-top: 3px;">
						<?php
							include("base/connect.php");
							connectDB();
							$articles = $mysqli->query("SELECT * FROM `verses` WHERE id =".$_GET['id']);
				...
				<table style="margin:auto; border-collapse:collapse; background-color:transparent; border-style:none;">
					<tbody>
						<tr>
							...
							<td style="font-style:italic; font-size : larger;">
								<p>
									<?php
